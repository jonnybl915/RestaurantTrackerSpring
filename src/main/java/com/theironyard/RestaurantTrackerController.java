...
public class RestaurantTrackerController {
    ...
    public String home(HttpSession session, Model model) {
        ...
        if (username == null) {
            ...
            Iterable<Restaurant> rests = restaurants.findAll(); //Key for inserting into Mustache
    ...
    public String createRestaurant(String name, String location, int rating, String comment) {
